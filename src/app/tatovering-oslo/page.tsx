...
export default function TatoveringOsloPage() {
  return (
    <AreaLandingPage
      ...
      travelEn="The studio is in Lørenskog, outside the pressure of central Oslo, with a calmer setting for consultations and serious custom tattoo projects."
      travelNo="Studioet ligger i Lørenskog, utenfor presset i Oslo sentrum, med roligere rammer for konsultasjoner og seriøse custom tatoveringsprosjekter."
