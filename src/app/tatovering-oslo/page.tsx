...
export const metadata: Metadata = {
  ...
  description:
    "Tatovering for kunder fra Oslo hos Infinity Tattoo i Lørenskog. Custom realisme, black and grey, blackout, portrett, sleeve og freehand Maori.",
  alternates: {
...
export default function TatoveringOsloPage() {
  return (
    <AreaLandingPage
      ...
      introEn="Clients from Oslo are welcome at Infinity Tattoo for custom realistic tattoos, black & grey portraits, blackout work, sleeve projects, cover-up planning, tooth gems, and freehand Maori tattoo work."
      introNo="Kunder fra Oslo er velkommen hos Infinity Tattoo for custom realistiske tatoveringer, black and grey portretter, blackout arbeid, sleeve-prosjekter, cover-up planlegging, tooth gems og freehand Maori."
