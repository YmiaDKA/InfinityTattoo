...
export const metadata: Metadata = {
  ...
  description:
    "Tatovering nær Strømmen hos Infinity Tattoo i Lørenskog. Custom tattoo, realisme, black and grey, blackout, portretter og freehand Maori.",
  alternates: {
...
export default function TatoveringStrommenPage() {
  return (
    <AreaLandingPage
      ...
      introEn="For clients looking for tattoo work near Strømmen, Infinity Tattoo offers custom realism, black & grey tattoos, blackout work, portrait work, large-scale planning, and freehand Maori flow pieces."
      introNo="For kunder som ser etter tatovering nær Strømmen tilbyr Infinity Tattoo custom realisme, black and grey tatoveringer, blackout arbeid, portretter, større prosjekter og freehand Maori med kroppsflyt."
