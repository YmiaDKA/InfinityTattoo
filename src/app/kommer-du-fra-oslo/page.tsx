...
export const metadata: Metadata = {
  ...
  description:
    "Custom tatovering nær Oslo uten stresset med parkering i sentrum. Infinity Tattoo i Lørenskog har 135+ Google-anmeldelser og tilbyr realisme, black and grey, blackout, fine line, Maori og konsultasjon.",
  alternates: {
...
export default function KommerDuFraOsloPage() {
  return (
    <AreaLandingPage
      ...
      travelEn="Many clients come from Oslo because longer tattoo sessions are easier to plan in a calmer studio setting, with less city stress before and after the appointment. The studio is backed by 135+ Google reviews."
      travelNo="Mange kunder kommer fra Oslo fordi lengre tatoveringstimer er enklere å planlegge i et roligere studio, med mindre bystress før og etter timen. Studioet har 135+ Google-anmeldelser."
