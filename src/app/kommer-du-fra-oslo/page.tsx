...
export const metadata: Metadata = {
  ...
  description:
    "Custom tatovering nær Oslo uten stresset med parkering i sentrum. Infinity Tattoo i Lørenskog tilbyr realisme, black and grey, fine line, Maori og konsultasjon.",
  alternates: {
...
export default function KommerDuFraOsloPage() {
  return (
    <AreaLandingPage
      ...
      focusEn="The studio focuses on custom realism, black & grey, portrait tattoos, sleeves, fine line, freehand Maori, cover-up planning, tooth gems, and clear consultations before booking."
      focusNo="Studioet fokuserer på custom realisme, black and grey, portrett tatoveringer, sleeves, fine line, freehand Maori, cover-up planlegging, tooth gems og tydelige konsultasjoner før booking."
    />
  );
}
