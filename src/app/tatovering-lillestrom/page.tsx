...
export const metadata: Metadata = {
  ...
  description:
    "Tatovering nær Lillestrøm hos Infinity Tattoo i Lørenskog. Custom realisme, black and grey, blackout, portrett, sleeve og freehand Maori.",
  alternates: {
...
export default function TatoveringLillestromPage() {
  return (
    <AreaLandingPage
      ...
      introEn="Looking for a tattoo studio near Lillestrøm? Infinity Tattoo in Lørenskog creates custom realistic tattoos, black & grey work, blackout projects, portraits, sleeves, cover-up planning, and freehand Maori pieces."
      introNo="Ser du etter tatovering nær Lillestrøm? Infinity Tattoo i Lørenskog lager custom realistiske tatoveringer, black and grey, blackout prosjekter, portretter, sleeves, cover-up planlegging og freehand Maori."
